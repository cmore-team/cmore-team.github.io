...
export default function FeatureGraphicResizer() {
    ...
    <div className="min-h-screen bg-black text-white">
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-black/70 border-b border-white/10">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center gap-4">
          ...
          <h1 className="text-sm font-medium">Feature Graphic Resizer</h1>
        </div>
      </nav>

      <main className="max-w-2xl mx-auto px-6 pt-24 pb-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Feature Graphic Resizer</h2>
          <p className="text-gray-400">
            Resize any image to 1024&times;500 PNG for Google Play Store
          </p>
        </div>
        ...
        <div className="p-8 rounded-2xl border border-white/10 bg-white/5">
          <input
            ...
            ref={fileInputRef}
            className="hidden"
            id="graphicResizerInput"
          />

          {!selectedImage ? (
            <label
              htmlFor="graphicResizerInput"
            ...
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="text-center">
                  ...
                  <img src={selectedImage} alt="Original" className="w-full max-w-[320px] mx-auto rounded-lg border border-white/10" />
                </div>
                <div className="text-center">
                  <p className="text-gray-400 text-sm mb-2">Resized (1024&times;500)</p>
                  <img src={resizedImage} alt="Resized" className="w-full max-w-[320px] mx-auto rounded-lg border border-white/10" />
                </div>
              </div>
