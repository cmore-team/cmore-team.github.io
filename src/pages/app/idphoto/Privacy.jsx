    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-3xl mx-auto px-6 pt-28 pb-20">
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          ...
          <p className="text-gray-400">사진이 기기를 떠나지 않습니다. 서버가 없고, 계정도 없으며, 얼굴 인식과 배경 분리와 규격 계산이 모두 기기 안에서 처리됩니다.</p>
          </section>
          <section>
          ...
          <p className="text-gray-400">구매 여부만 기기에 저장됩니다. 사진은 저장하지 않습니다. 앱을 삭제하면 이 정보도 함께 삭제됩니다.</p>
          </section>
          <section>
