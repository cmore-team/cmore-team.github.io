...
export default function LoanplanPrivacy() {
  return (
      ...
      <main className="max-w-3xl mx-auto px-6 pt-28 pb-20">
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          <section>
            ...
            <p className="text-gray-400">입력한 대출 조건이 기기를 떠나지 않습니다. 은행·계좌를 연동하지 않으며, 계산은 전부 기기 안에서 처리됩니다.</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">데이터는 전송되지 않습니다</h2>
            <p className="text-gray-400">입력한 대출 조건과 저장한 시나리오는 기기 안에서만 계산·저장됩니다. 개발자의 서버나 제3자 서버로 업로드되지 않습니다. 이 앱은 광고 SDK와 크래시 리포팅 SDK를 포함하지 않으며 비행기 모드에서 모든 기능이 동작합니다.</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">기기에 저장되는 정보</h2>
            <p className="text-gray-400">저장한 대출 시나리오와 구매 여부만 기기에 저장됩니다. 앱을 삭제하면 함께 삭제됩니다.</p>
          </section>
          <section>
